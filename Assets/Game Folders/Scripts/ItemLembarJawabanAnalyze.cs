...
public class ItemLembarJawabanAnalyze : MonoBehaviour
{
    ...
    public void Initiate(TugasAnalyze data, int n)
    {
        ...
        {
            GetComponentInParent<AnalyzePanelGuru>().OpenPanelPenilaian(nomor);
        });
