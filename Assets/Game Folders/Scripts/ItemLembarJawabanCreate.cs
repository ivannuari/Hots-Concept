...
public class ItemLembarJawabanCreate : MonoBehaviour
{
    ...
    public void Initiate(TugasCreate data , int n)
    {
        ...
        {
            GetComponentInParent<CreatePanelGuru>().OpenPanelPenilaian(nomor);
        });
